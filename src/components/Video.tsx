...
const Video: React.FC = () => {
  return (
    <>
      <div>
        <div className="fixed top-0 left-0 object-cover w-full h-full bg-black z-10 opacity-70"></div>
        ...
        <div className="fixed top-0 left-0 object-cover w-full h-full z-20 flex items-center justify-center">
          <img src={logo}/>
        </div>
      </div>
    </>
